<form class="navbar-form navbar-right" role="search" action="<?php echo home_url( '/' ); ?>">
  <div class="form-group">
    <input type="text" class="form-control" placeholder="<?php echo esc_attr_x( 'Поиск...', 'placeholder' ) ?>" title="<?php echo esc_attr_x( 'Результаты для:', 'label' ) ?>" value="<?php echo get_search_query() ?>"
     />
  </div>
